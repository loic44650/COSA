...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Role Fourni Gamma DB</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link client_serveur.impl.Role_Fourni_Gamma_DBImpl#getAttachment_gamma_db <em>Attachment gamma db</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Role_Fourni_Gamma_DBImpl extends Role_FourniImpl implements Role_Fourni_Gamma_DB {
	/**
	 ...
	 * @generated
	 */
	protected Role_Fourni_Gamma_DBImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Client_serveurPackage.Literals.ROLE_FOURNI_GAMMA_DB;
	}
		...
		if (attachment_gamma_db != null && attachment_gamma_db.eIsProxy()) {
			...
			if (attachment_gamma_db != oldAttachment_gamma_db) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Client_serveurPackage.ROLE_FOURNI_GAMMA_DB__ATTACHMENT_GAMMA_DB, oldAttachment_gamma_db, attachment_gamma_db));
			}
		}
	...
	public NotificationChain basicSetAttachment_gamma_db(Attachment_Gamma_DB newAttachment_gamma_db, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.ROLE_FOURNI_GAMMA_DB__ATTACHMENT_GAMMA_DB, oldAttachment_gamma_db, newAttachment_gamma_db);
	...
	public void setAttachment_gamma_db(Attachment_Gamma_DB newAttachment_gamma_db) {
		if (newAttachment_gamma_db != attachment_gamma_db) {
			...
			if (attachment_gamma_db != null)
				msgs = ((InternalEObject)attachment_gamma_db).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_GAMMA_DB__ROLE_FOURNI_GAMMA_DB, Attachment_Gamma_DB.class, msgs);
			if (newAttachment_gamma_db != null)
				msgs = ((InternalEObject)newAttachment_gamma_db).eInverseAdd(this, Client_serveurPackage.ATTACHMENT_GAMMA_DB__ROLE_FOURNI_GAMMA_DB, Attachment_Gamma_DB.class, msgs);
			msgs = basicSetAttachment_gamma_db(newAttachment_gamma_db, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.ROLE_FOURNI_GAMMA_DB__ATTACHMENT_GAMMA_DB, newAttachment_gamma_db, newAttachment_gamma_db));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Client_serveurPackage.ROLE_FOURNI_GAMMA_DB__ATTACHMENT_GAMMA_DB:
				if (attachment_gamma_db != null)
					msgs = ((InternalEObject)attachment_gamma_db).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_GAMMA_DB__ROLE_FOURNI_GAMMA_DB, Attachment_Gamma_DB.class, msgs);
