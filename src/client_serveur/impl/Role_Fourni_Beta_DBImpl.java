...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Role Fourni Beta DB</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link client_serveur.impl.Role_Fourni_Beta_DBImpl#getAttachment_beta_db <em>Attachment beta db</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Role_Fourni_Beta_DBImpl extends Role_FourniImpl implements Role_Fourni_Beta_DB {
	/**
	 ...
	 * @generated
	 */
	protected Role_Fourni_Beta_DBImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Client_serveurPackage.Literals.ROLE_FOURNI_BETA_DB;
	}
		...
		if (attachment_beta_db != null && attachment_beta_db.eIsProxy()) {
			...
			if (attachment_beta_db != oldAttachment_beta_db) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Client_serveurPackage.ROLE_FOURNI_BETA_DB__ATTACHMENT_BETA_DB, oldAttachment_beta_db, attachment_beta_db));
			}
		}
	...
	public NotificationChain basicSetAttachment_beta_db(Attachment_Beta_DB newAttachment_beta_db, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.ROLE_FOURNI_BETA_DB__ATTACHMENT_BETA_DB, oldAttachment_beta_db, newAttachment_beta_db);
	...
	public void setAttachment_beta_db(Attachment_Beta_DB newAttachment_beta_db) {
		if (newAttachment_beta_db != attachment_beta_db) {
			...
			if (attachment_beta_db != null)
				msgs = ((InternalEObject)attachment_beta_db).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_BETA_DB__ROLE_FOURNI_BETA_DB, Attachment_Beta_DB.class, msgs);
			if (newAttachment_beta_db != null)
				msgs = ((InternalEObject)newAttachment_beta_db).eInverseAdd(this, Client_serveurPackage.ATTACHMENT_BETA_DB__ROLE_FOURNI_BETA_DB, Attachment_Beta_DB.class, msgs);
			msgs = basicSetAttachment_beta_db(newAttachment_beta_db, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.ROLE_FOURNI_BETA_DB__ATTACHMENT_BETA_DB, newAttachment_beta_db, newAttachment_beta_db));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Client_serveurPackage.ROLE_FOURNI_BETA_DB__ATTACHMENT_BETA_DB:
				if (attachment_beta_db != null)
					msgs = ((InternalEObject)attachment_beta_db).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_BETA_DB__ROLE_FOURNI_BETA_DB, Attachment_Beta_DB.class, msgs);
