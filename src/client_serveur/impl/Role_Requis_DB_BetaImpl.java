...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Role Requis DB Beta</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link client_serveur.impl.Role_Requis_DB_BetaImpl#getAttachment_db_beta <em>Attachment db beta</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Role_Requis_DB_BetaImpl extends Role_RequisImpl implements Role_Requis_DB_Beta {
	/**
	 ...
	 * @generated
	 */
	protected Role_Requis_DB_BetaImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Client_serveurPackage.Literals.ROLE_REQUIS_DB_BETA;
	}
		...
		if (attachment_db_beta != null && attachment_db_beta.eIsProxy()) {
			...
			if (attachment_db_beta != oldAttachment_db_beta) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Client_serveurPackage.ROLE_REQUIS_DB_BETA__ATTACHMENT_DB_BETA, oldAttachment_db_beta, attachment_db_beta));
			}
		}
	...
	public NotificationChain basicSetAttachment_db_beta(Attachment_DB_Beta newAttachment_db_beta, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.ROLE_REQUIS_DB_BETA__ATTACHMENT_DB_BETA, oldAttachment_db_beta, newAttachment_db_beta);
	...
	public void setAttachment_db_beta(Attachment_DB_Beta newAttachment_db_beta) {
		if (newAttachment_db_beta != attachment_db_beta) {
			...
			if (attachment_db_beta != null)
				msgs = ((InternalEObject)attachment_db_beta).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_DB_BETA__ROLE_REQUIS_DB_BETA, Attachment_DB_Beta.class, msgs);
			if (newAttachment_db_beta != null)
				msgs = ((InternalEObject)newAttachment_db_beta).eInverseAdd(this, Client_serveurPackage.ATTACHMENT_DB_BETA__ROLE_REQUIS_DB_BETA, Attachment_DB_Beta.class, msgs);
			msgs = basicSetAttachment_db_beta(newAttachment_db_beta, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.ROLE_REQUIS_DB_BETA__ATTACHMENT_DB_BETA, newAttachment_db_beta, newAttachment_db_beta));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Client_serveurPackage.ROLE_REQUIS_DB_BETA__ATTACHMENT_DB_BETA:
				if (attachment_db_beta != null)
					msgs = ((InternalEObject)attachment_db_beta).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_DB_BETA__ROLE_REQUIS_DB_BETA, Attachment_DB_Beta.class, msgs);
