...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Role Requis DB Gamma</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link client_serveur.impl.Role_Requis_DB_GammaImpl#getAttachment_db_gamma <em>Attachment db gamma</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Role_Requis_DB_GammaImpl extends Role_RequisImpl implements Role_Requis_DB_Gamma {
	/**
	 ...
	 * @generated
	 */
	protected Role_Requis_DB_GammaImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Client_serveurPackage.Literals.ROLE_REQUIS_DB_GAMMA;
	}
		...
		if (attachment_db_gamma != null && attachment_db_gamma.eIsProxy()) {
			...
			if (attachment_db_gamma != oldAttachment_db_gamma) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Client_serveurPackage.ROLE_REQUIS_DB_GAMMA__ATTACHMENT_DB_GAMMA, oldAttachment_db_gamma, attachment_db_gamma));
			}
		}
	...
	public NotificationChain basicSetAttachment_db_gamma(Attachment_DB_Gamma newAttachment_db_gamma, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.ROLE_REQUIS_DB_GAMMA__ATTACHMENT_DB_GAMMA, oldAttachment_db_gamma, newAttachment_db_gamma);
	...
	public void setAttachment_db_gamma(Attachment_DB_Gamma newAttachment_db_gamma) {
		if (newAttachment_db_gamma != attachment_db_gamma) {
			...
			if (attachment_db_gamma != null)
				msgs = ((InternalEObject)attachment_db_gamma).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_DB_GAMMA__ROLE_REQUIS_DB_GAMMA, Attachment_DB_Gamma.class, msgs);
			if (newAttachment_db_gamma != null)
				msgs = ((InternalEObject)newAttachment_db_gamma).eInverseAdd(this, Client_serveurPackage.ATTACHMENT_DB_GAMMA__ROLE_REQUIS_DB_GAMMA, Attachment_DB_Gamma.class, msgs);
			msgs = basicSetAttachment_db_gamma(newAttachment_db_gamma, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.ROLE_REQUIS_DB_GAMMA__ATTACHMENT_DB_GAMMA, newAttachment_db_gamma, newAttachment_db_gamma));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Client_serveurPackage.ROLE_REQUIS_DB_GAMMA__ATTACHMENT_DB_GAMMA:
				if (attachment_db_gamma != null)
					msgs = ((InternalEObject)attachment_db_gamma).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_DB_GAMMA__ROLE_REQUIS_DB_GAMMA, Attachment_DB_Gamma.class, msgs);
