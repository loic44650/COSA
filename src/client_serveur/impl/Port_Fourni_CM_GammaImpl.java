...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Port Fourni CM Gamma</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link client_serveur.impl.Port_Fourni_CM_GammaImpl#getAttachment_cm_gamma <em>Attachment cm gamma</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Port_Fourni_CM_GammaImpl extends Port_FourniImpl implements Port_Fourni_CM_Gamma {
	/**
	 ...
	 * @generated
	 */
	protected Port_Fourni_CM_GammaImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Client_serveurPackage.Literals.PORT_FOURNI_CM_GAMMA;
	}
		...
		if (attachment_cm_gamma != null && attachment_cm_gamma.eIsProxy()) {
			...
			if (attachment_cm_gamma != oldAttachment_cm_gamma) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Client_serveurPackage.PORT_FOURNI_CM_GAMMA__ATTACHMENT_CM_GAMMA, oldAttachment_cm_gamma, attachment_cm_gamma));
			}
		}
	...
	public NotificationChain basicSetAttachment_cm_gamma(Attachment_CM_Gamma newAttachment_cm_gamma, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_FOURNI_CM_GAMMA__ATTACHMENT_CM_GAMMA, oldAttachment_cm_gamma, newAttachment_cm_gamma);
	...
	public void setAttachment_cm_gamma(Attachment_CM_Gamma newAttachment_cm_gamma) {
		if (newAttachment_cm_gamma != attachment_cm_gamma) {
			...
			if (attachment_cm_gamma != null)
				msgs = ((InternalEObject)attachment_cm_gamma).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_CM_GAMMA__PORT_FOURNI_CM_GAMMA, Attachment_CM_Gamma.class, msgs);
			if (newAttachment_cm_gamma != null)
				msgs = ((InternalEObject)newAttachment_cm_gamma).eInverseAdd(this, Client_serveurPackage.ATTACHMENT_CM_GAMMA__PORT_FOURNI_CM_GAMMA, Attachment_CM_Gamma.class, msgs);
			msgs = basicSetAttachment_cm_gamma(newAttachment_cm_gamma, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_FOURNI_CM_GAMMA__ATTACHMENT_CM_GAMMA, newAttachment_cm_gamma, newAttachment_cm_gamma));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Client_serveurPackage.PORT_FOURNI_CM_GAMMA__ATTACHMENT_CM_GAMMA:
				if (attachment_cm_gamma != null)
					msgs = ((InternalEObject)attachment_cm_gamma).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_CM_GAMMA__PORT_FOURNI_CM_GAMMA, Attachment_CM_Gamma.class, msgs);
