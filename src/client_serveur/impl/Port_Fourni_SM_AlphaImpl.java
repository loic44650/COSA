...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Port Fourni SM Alpha</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link client_serveur.impl.Port_Fourni_SM_AlphaImpl#getAttachment_sm_alpha <em>Attachment sm alpha</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Port_Fourni_SM_AlphaImpl extends Port_FourniImpl implements Port_Fourni_SM_Alpha {
	/**
	 ...
	 * @generated
	 */
	protected Port_Fourni_SM_AlphaImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Client_serveurPackage.Literals.PORT_FOURNI_SM_ALPHA;
	}
		...
		if (attachment_sm_alpha != null && attachment_sm_alpha.eIsProxy()) {
			...
			if (attachment_sm_alpha != oldAttachment_sm_alpha) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Client_serveurPackage.PORT_FOURNI_SM_ALPHA__ATTACHMENT_SM_ALPHA, oldAttachment_sm_alpha, attachment_sm_alpha));
			}
		}
	...
	public NotificationChain basicSetAttachment_sm_alpha(Attachment_SM_Alpha newAttachment_sm_alpha, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_FOURNI_SM_ALPHA__ATTACHMENT_SM_ALPHA, oldAttachment_sm_alpha, newAttachment_sm_alpha);
	...
	public void setAttachment_sm_alpha(Attachment_SM_Alpha newAttachment_sm_alpha) {
		if (newAttachment_sm_alpha != attachment_sm_alpha) {
			...
			if (attachment_sm_alpha != null)
				msgs = ((InternalEObject)attachment_sm_alpha).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_SM_ALPHA__PORT_FOURNI_SM_ALPHA, Attachment_SM_Alpha.class, msgs);
			if (newAttachment_sm_alpha != null)
				msgs = ((InternalEObject)newAttachment_sm_alpha).eInverseAdd(this, Client_serveurPackage.ATTACHMENT_SM_ALPHA__PORT_FOURNI_SM_ALPHA, Attachment_SM_Alpha.class, msgs);
			msgs = basicSetAttachment_sm_alpha(newAttachment_sm_alpha, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_FOURNI_SM_ALPHA__ATTACHMENT_SM_ALPHA, newAttachment_sm_alpha, newAttachment_sm_alpha));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Client_serveurPackage.PORT_FOURNI_SM_ALPHA__ATTACHMENT_SM_ALPHA:
				if (attachment_sm_alpha != null)
					msgs = ((InternalEObject)attachment_sm_alpha).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_SM_ALPHA__PORT_FOURNI_SM_ALPHA, Attachment_SM_Alpha.class, msgs);
