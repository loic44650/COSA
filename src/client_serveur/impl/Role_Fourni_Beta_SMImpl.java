...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Role Fourni Beta SM</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link client_serveur.impl.Role_Fourni_Beta_SMImpl#getAttachment_beta_sm <em>Attachment beta sm</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Role_Fourni_Beta_SMImpl extends Role_FourniImpl implements Role_Fourni_Beta_SM {
	/**
	 ...
	 * @generated
	 */
	protected Role_Fourni_Beta_SMImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Client_serveurPackage.Literals.ROLE_FOURNI_BETA_SM;
	}
		...
		if (attachment_beta_sm != null && attachment_beta_sm.eIsProxy()) {
			...
			if (attachment_beta_sm != oldAttachment_beta_sm) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Client_serveurPackage.ROLE_FOURNI_BETA_SM__ATTACHMENT_BETA_SM, oldAttachment_beta_sm, attachment_beta_sm));
			}
		}
	...
	public NotificationChain basicSetAttachment_beta_sm(Attachment_Beta_SM newAttachment_beta_sm, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.ROLE_FOURNI_BETA_SM__ATTACHMENT_BETA_SM, oldAttachment_beta_sm, newAttachment_beta_sm);
	...
	public void setAttachment_beta_sm(Attachment_Beta_SM newAttachment_beta_sm) {
		if (newAttachment_beta_sm != attachment_beta_sm) {
			...
			if (attachment_beta_sm != null)
				msgs = ((InternalEObject)attachment_beta_sm).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_BETA_SM__ROLE_FOURNI_BETA_SM, Attachment_Beta_SM.class, msgs);
			if (newAttachment_beta_sm != null)
				msgs = ((InternalEObject)newAttachment_beta_sm).eInverseAdd(this, Client_serveurPackage.ATTACHMENT_BETA_SM__ROLE_FOURNI_BETA_SM, Attachment_Beta_SM.class, msgs);
			msgs = basicSetAttachment_beta_sm(newAttachment_beta_sm, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.ROLE_FOURNI_BETA_SM__ATTACHMENT_BETA_SM, newAttachment_beta_sm, newAttachment_beta_sm));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Client_serveurPackage.ROLE_FOURNI_BETA_SM__ATTACHMENT_BETA_SM:
				if (attachment_beta_sm != null)
					msgs = ((InternalEObject)attachment_beta_sm).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_BETA_SM__ROLE_FOURNI_BETA_SM, Attachment_Beta_SM.class, msgs);
