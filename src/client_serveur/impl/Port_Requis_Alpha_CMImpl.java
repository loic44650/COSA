...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Port Requis Alpha CM</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link client_serveur.impl.Port_Requis_Alpha_CMImpl#getAttachment_alpha_cm <em>Attachment alpha cm</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Port_Requis_Alpha_CMImpl extends Port_RequisImpl implements Port_Requis_Alpha_CM {
	/**
	 ...
	 * @generated
	 */
	protected Port_Requis_Alpha_CMImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Client_serveurPackage.Literals.PORT_REQUIS_ALPHA_CM;
	}
		...
		if (attachment_alpha_cm != null && attachment_alpha_cm.eIsProxy()) {
			...
			if (attachment_alpha_cm != oldAttachment_alpha_cm) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Client_serveurPackage.PORT_REQUIS_ALPHA_CM__ATTACHMENT_ALPHA_CM, oldAttachment_alpha_cm, attachment_alpha_cm));
			}
		}
	...
	public NotificationChain basicSetAttachment_alpha_cm(Attachment_Alpha_CM newAttachment_alpha_cm, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_REQUIS_ALPHA_CM__ATTACHMENT_ALPHA_CM, oldAttachment_alpha_cm, newAttachment_alpha_cm);
	...
	public void setAttachment_alpha_cm(Attachment_Alpha_CM newAttachment_alpha_cm) {
		if (newAttachment_alpha_cm != attachment_alpha_cm) {
			...
			if (attachment_alpha_cm != null)
				msgs = ((InternalEObject)attachment_alpha_cm).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_ALPHA_CM__PORT_REQUIS_ALPHA_CM, Attachment_Alpha_CM.class, msgs);
			if (newAttachment_alpha_cm != null)
				msgs = ((InternalEObject)newAttachment_alpha_cm).eInverseAdd(this, Client_serveurPackage.ATTACHMENT_ALPHA_CM__PORT_REQUIS_ALPHA_CM, Attachment_Alpha_CM.class, msgs);
			msgs = basicSetAttachment_alpha_cm(newAttachment_alpha_cm, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_REQUIS_ALPHA_CM__ATTACHMENT_ALPHA_CM, newAttachment_alpha_cm, newAttachment_alpha_cm));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Client_serveurPackage.PORT_REQUIS_ALPHA_CM__ATTACHMENT_ALPHA_CM:
				if (attachment_alpha_cm != null)
					msgs = ((InternalEObject)attachment_alpha_cm).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_ALPHA_CM__PORT_REQUIS_ALPHA_CM, Attachment_Alpha_CM.class, msgs);
