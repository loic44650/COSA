...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Port Serveur Comp CM</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link client_serveur.impl.Port_Serveur_Comp_CMImpl#getBinding_serveur_comp_cm <em>Binding serveur comp cm</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Port_Serveur_Comp_CMImpl extends PortImpl implements Port_Serveur_Comp_CM {
	/**
	 ...
	 * @generated
	 */
	protected Port_Serveur_Comp_CMImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Client_serveurPackage.Literals.PORT_SERVEUR_COMP_CM;
	}
		...
		if (binding_serveur_comp_cm != null && binding_serveur_comp_cm.eIsProxy()) {
			...
			if (binding_serveur_comp_cm != oldBinding_serveur_comp_cm) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Client_serveurPackage.PORT_SERVEUR_COMP_CM__BINDING_SERVEUR_COMP_CM, oldBinding_serveur_comp_cm, binding_serveur_comp_cm));
			}
		}
	...
	public NotificationChain basicSetBinding_serveur_comp_cm(Binding_Serveur_Comp_CM newBinding_serveur_comp_cm, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_SERVEUR_COMP_CM__BINDING_SERVEUR_COMP_CM, oldBinding_serveur_comp_cm, newBinding_serveur_comp_cm);
	...
	public void setBinding_serveur_comp_cm(Binding_Serveur_Comp_CM newBinding_serveur_comp_cm) {
		if (newBinding_serveur_comp_cm != binding_serveur_comp_cm) {
			...
			if (binding_serveur_comp_cm != null)
				msgs = ((InternalEObject)binding_serveur_comp_cm).eInverseRemove(this, Client_serveurPackage.BINDING_SERVEUR_COMP_CM__PORT_SERVEUR_COMP_CM, Binding_Serveur_Comp_CM.class, msgs);
			if (newBinding_serveur_comp_cm != null)
				msgs = ((InternalEObject)newBinding_serveur_comp_cm).eInverseAdd(this, Client_serveurPackage.BINDING_SERVEUR_COMP_CM__PORT_SERVEUR_COMP_CM, Binding_Serveur_Comp_CM.class, msgs);
			msgs = basicSetBinding_serveur_comp_cm(newBinding_serveur_comp_cm, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_SERVEUR_COMP_CM__BINDING_SERVEUR_COMP_CM, newBinding_serveur_comp_cm, newBinding_serveur_comp_cm));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Client_serveurPackage.PORT_SERVEUR_COMP_CM__BINDING_SERVEUR_COMP_CM:
				if (binding_serveur_comp_cm != null)
					msgs = ((InternalEObject)binding_serveur_comp_cm).eInverseRemove(this, Client_serveurPackage.BINDING_SERVEUR_COMP_CM__PORT_SERVEUR_COMP_CM, Binding_Serveur_Comp_CM.class, msgs);
