...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Port Fourni SM Beta</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link client_serveur.impl.Port_Fourni_SM_BetaImpl#getAttachment_sm_beta <em>Attachment sm beta</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Port_Fourni_SM_BetaImpl extends Port_FourniImpl implements Port_Fourni_SM_Beta {
	/**
	 ...
	 * @generated
	 */
	protected Port_Fourni_SM_BetaImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Client_serveurPackage.Literals.PORT_FOURNI_SM_BETA;
	}
		...
		if (attachment_sm_beta != null && attachment_sm_beta.eIsProxy()) {
			...
			if (attachment_sm_beta != oldAttachment_sm_beta) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Client_serveurPackage.PORT_FOURNI_SM_BETA__ATTACHMENT_SM_BETA, oldAttachment_sm_beta, attachment_sm_beta));
			}
		}
	...
	public NotificationChain basicSetAttachment_sm_beta(Attachment_SM_Beta newAttachment_sm_beta, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_FOURNI_SM_BETA__ATTACHMENT_SM_BETA, oldAttachment_sm_beta, newAttachment_sm_beta);
	...
	public void setAttachment_sm_beta(Attachment_SM_Beta newAttachment_sm_beta) {
		if (newAttachment_sm_beta != attachment_sm_beta) {
			...
			if (attachment_sm_beta != null)
				msgs = ((InternalEObject)attachment_sm_beta).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_SM_BETA__PORT_FOURNI_SM_BETA, Attachment_SM_Beta.class, msgs);
			if (newAttachment_sm_beta != null)
				msgs = ((InternalEObject)newAttachment_sm_beta).eInverseAdd(this, Client_serveurPackage.ATTACHMENT_SM_BETA__PORT_FOURNI_SM_BETA, Attachment_SM_Beta.class, msgs);
			msgs = basicSetAttachment_sm_beta(newAttachment_sm_beta, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_FOURNI_SM_BETA__ATTACHMENT_SM_BETA, newAttachment_sm_beta, newAttachment_sm_beta));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Client_serveurPackage.PORT_FOURNI_SM_BETA__ATTACHMENT_SM_BETA:
				if (attachment_sm_beta != null)
					msgs = ((InternalEObject)attachment_sm_beta).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_SM_BETA__PORT_FOURNI_SM_BETA, Attachment_SM_Beta.class, msgs);
