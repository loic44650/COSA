...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Role Fourni Alpha SM</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link client_serveur.impl.Role_Fourni_Alpha_SMImpl#getAttachment_alpha_sm <em>Attachment alpha sm</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Role_Fourni_Alpha_SMImpl extends Role_FourniImpl implements Role_Fourni_Alpha_SM {
	/**
	 ...
	 * @generated
	 */
	protected Role_Fourni_Alpha_SMImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Client_serveurPackage.Literals.ROLE_FOURNI_ALPHA_SM;
	}
		...
		if (attachment_alpha_sm != null && attachment_alpha_sm.eIsProxy()) {
			...
			if (attachment_alpha_sm != oldAttachment_alpha_sm) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Client_serveurPackage.ROLE_FOURNI_ALPHA_SM__ATTACHMENT_ALPHA_SM, oldAttachment_alpha_sm, attachment_alpha_sm));
			}
		}
	...
	public NotificationChain basicSetAttachment_alpha_sm(Attachment_Alpha_SM newAttachment_alpha_sm, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.ROLE_FOURNI_ALPHA_SM__ATTACHMENT_ALPHA_SM, oldAttachment_alpha_sm, newAttachment_alpha_sm);
	...
	public void setAttachment_alpha_sm(Attachment_Alpha_SM newAttachment_alpha_sm) {
		if (newAttachment_alpha_sm != attachment_alpha_sm) {
			...
			if (attachment_alpha_sm != null)
				msgs = ((InternalEObject)attachment_alpha_sm).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_ALPHA_SM__ROLE_FOURNI_ALPHA_SM, Attachment_Alpha_SM.class, msgs);
			if (newAttachment_alpha_sm != null)
				msgs = ((InternalEObject)newAttachment_alpha_sm).eInverseAdd(this, Client_serveurPackage.ATTACHMENT_ALPHA_SM__ROLE_FOURNI_ALPHA_SM, Attachment_Alpha_SM.class, msgs);
			msgs = basicSetAttachment_alpha_sm(newAttachment_alpha_sm, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.ROLE_FOURNI_ALPHA_SM__ATTACHMENT_ALPHA_SM, newAttachment_alpha_sm, newAttachment_alpha_sm));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Client_serveurPackage.ROLE_FOURNI_ALPHA_SM__ATTACHMENT_ALPHA_SM:
				if (attachment_alpha_sm != null)
					msgs = ((InternalEObject)attachment_alpha_sm).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_ALPHA_SM__ROLE_FOURNI_ALPHA_SM, Attachment_Alpha_SM.class, msgs);
