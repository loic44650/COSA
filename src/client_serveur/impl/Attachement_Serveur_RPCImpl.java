 ...
 * </p>
 * <ul>
 *   <li>{@link client_serveur.impl.Attachement_Serveur_RPCImpl#getRole_requis_rpc_serveur <em>Role requis rpc serveur</em>}</li>
 *   <li>{@link client_serveur.impl.Attachement_Serveur_RPCImpl#getPort_fourni_serveur <em>Port fourni serveur</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Attachement_Serveur_RPCImpl extends AttachmentImpl implements Attachement_Serveur_RPC {
	/**
	 ...
	 * @generated
	 */
	protected Attachement_Serveur_RPCImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Client_serveurPackage.Literals.ATTACHEMENT_SERVEUR_RPC;
	}
		...
		if (role_requis_rpc_serveur != null && role_requis_rpc_serveur.eIsProxy()) {
			...
			if (role_requis_rpc_serveur != oldRole_requis_rpc_serveur) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Client_serveurPackage.ATTACHEMENT_SERVEUR_RPC__ROLE_REQUIS_RPC_SERVEUR, oldRole_requis_rpc_serveur, role_requis_rpc_serveur));
			}
		}
	...
	public NotificationChain basicSetRole_requis_rpc_serveur(Role_Requis_RPC_Serveur newRole_requis_rpc_serveur, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.ATTACHEMENT_SERVEUR_RPC__ROLE_REQUIS_RPC_SERVEUR, oldRole_requis_rpc_serveur, newRole_requis_rpc_serveur);
	...
	public void setRole_requis_rpc_serveur(Role_Requis_RPC_Serveur newRole_requis_rpc_serveur) {
		if (newRole_requis_rpc_serveur != role_requis_rpc_serveur) {
			...
			if (role_requis_rpc_serveur != null)
				msgs = ((InternalEObject)role_requis_rpc_serveur).eInverseRemove(this, Client_serveurPackage.ROLE_REQUIS_RPC_SERVEUR__ATTACHEMENT_SERVEUR_RPC, Role_Requis_RPC_Serveur.class, msgs);
			if (newRole_requis_rpc_serveur != null)
				msgs = ((InternalEObject)newRole_requis_rpc_serveur).eInverseAdd(this, Client_serveurPackage.ROLE_REQUIS_RPC_SERVEUR__ATTACHEMENT_SERVEUR_RPC, Role_Requis_RPC_Serveur.class, msgs);
			msgs = basicSetRole_requis_rpc_serveur(newRole_requis_rpc_serveur, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.ATTACHEMENT_SERVEUR_RPC__ROLE_REQUIS_RPC_SERVEUR, newRole_requis_rpc_serveur, newRole_requis_rpc_serveur));
	}
	...
	public Port_Fourni_Serveur getPort_fourni_serveur() {
		if (port_fourni_serveur != null && port_fourni_serveur.eIsProxy()) {
			...
			if (port_fourni_serveur != oldPort_fourni_serveur) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Client_serveurPackage.ATTACHEMENT_SERVEUR_RPC__PORT_FOURNI_SERVEUR, oldPort_fourni_serveur, port_fourni_serveur));
			}
		}
	...
	public NotificationChain basicSetPort_fourni_serveur(Port_Fourni_Serveur newPort_fourni_serveur, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.ATTACHEMENT_SERVEUR_RPC__PORT_FOURNI_SERVEUR, oldPort_fourni_serveur, newPort_fourni_serveur);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPort_fourni_serveur(Port_Fourni_Serveur newPort_fourni_serveur) {
		if (newPort_fourni_serveur != port_fourni_serveur) {
			...
			if (port_fourni_serveur != null)
				msgs = ((InternalEObject)port_fourni_serveur).eInverseRemove(this, Client_serveurPackage.PORT_FOURNI_SERVEUR__ATTACHEMENT_SERVEUR_RPC, Port_Fourni_Serveur.class, msgs);
			if (newPort_fourni_serveur != null)
				msgs = ((InternalEObject)newPort_fourni_serveur).eInverseAdd(this, Client_serveurPackage.PORT_FOURNI_SERVEUR__ATTACHEMENT_SERVEUR_RPC, Port_Fourni_Serveur.class, msgs);
			msgs = basicSetPort_fourni_serveur(newPort_fourni_serveur, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.ATTACHEMENT_SERVEUR_RPC__PORT_FOURNI_SERVEUR, newPort_fourni_serveur, newPort_fourni_serveur));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Client_serveurPackage.ATTACHEMENT_SERVEUR_RPC__ROLE_REQUIS_RPC_SERVEUR:
				if (role_requis_rpc_serveur != null)
					msgs = ((InternalEObject)role_requis_rpc_serveur).eInverseRemove(this, Client_serveurPackage.ROLE_REQUIS_RPC_SERVEUR__ATTACHEMENT_SERVEUR_RPC, Role_Requis_RPC_Serveur.class, msgs);
				return basicSetRole_requis_rpc_serveur((Role_Requis_RPC_Serveur)otherEnd, msgs);
			case Client_serveurPackage.ATTACHEMENT_SERVEUR_RPC__PORT_FOURNI_SERVEUR:
				if (port_fourni_serveur != null)
					msgs = ((InternalEObject)port_fourni_serveur).eInverseRemove(this, Client_serveurPackage.PORT_FOURNI_SERVEUR__ATTACHEMENT_SERVEUR_RPC, Port_Fourni_Serveur.class, msgs);
