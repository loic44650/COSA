...
public class Port_Requis_ServeurImpl extends Port_RequisImpl implements Port_Requis_Serveur {
	...
	public NotificationChain basicSetAttachment_rpc_serveur(Attachment_RPC_Serveur newAttachment_rpc_serveur, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_REQUIS_SERVEUR__ATTACHMENT_RPC_SERVEUR, oldAttachment_rpc_serveur, newAttachment_rpc_serveur);
	...
	public void setAttachment_rpc_serveur(Attachment_RPC_Serveur newAttachment_rpc_serveur) {
		if (newAttachment_rpc_serveur != attachment_rpc_serveur) {
			...
			if (attachment_rpc_serveur != null)
				msgs = ((InternalEObject)attachment_rpc_serveur).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_RPC_SERVEUR__PORT_REQUIS_SERVEUR, Attachment_RPC_Serveur.class, msgs);
			if (newAttachment_rpc_serveur != null)
				msgs = ((InternalEObject)newAttachment_rpc_serveur).eInverseAdd(this, Client_serveurPackage.ATTACHMENT_RPC_SERVEUR__PORT_REQUIS_SERVEUR, Attachment_RPC_Serveur.class, msgs);
			msgs = basicSetAttachment_rpc_serveur(newAttachment_rpc_serveur, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_REQUIS_SERVEUR__ATTACHMENT_RPC_SERVEUR, newAttachment_rpc_serveur, newAttachment_rpc_serveur));
	}
