 ...
 * </p>
 * <ul>
 *   <li>{@link client_serveur.impl.Port_Fourni_ServeurImpl#getAttachment_serveur_rpc <em>Attachment serveur rpc</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Port_Fourni_ServeurImpl extends Port_FourniImpl implements Port_Fourni_Serveur {
		...
		if (attachment_serveur_rpc != null && attachment_serveur_rpc.eIsProxy()) {
			...
			if (attachment_serveur_rpc != oldAttachment_serveur_rpc) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Client_serveurPackage.PORT_FOURNI_SERVEUR__ATTACHMENT_SERVEUR_RPC, oldAttachment_serveur_rpc, attachment_serveur_rpc));
			}
		}
	...
	public NotificationChain basicSetAttachment_serveur_rpc(Attachment_Serveur_RPC newAttachment_serveur_rpc, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_FOURNI_SERVEUR__ATTACHMENT_SERVEUR_RPC, oldAttachment_serveur_rpc, newAttachment_serveur_rpc);
	...
	public void setAttachment_serveur_rpc(Attachment_Serveur_RPC newAttachment_serveur_rpc) {
		if (newAttachment_serveur_rpc != attachment_serveur_rpc) {
			...
			if (attachment_serveur_rpc != null)
				msgs = ((InternalEObject)attachment_serveur_rpc).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_SERVEUR_RPC__PORT_FOURNI_SERVEUR, Attachment_Serveur_RPC.class, msgs);
			if (newAttachment_serveur_rpc != null)
				msgs = ((InternalEObject)newAttachment_serveur_rpc).eInverseAdd(this, Client_serveurPackage.ATTACHMENT_SERVEUR_RPC__PORT_FOURNI_SERVEUR, Attachment_Serveur_RPC.class, msgs);
			msgs = basicSetAttachment_serveur_rpc(newAttachment_serveur_rpc, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_FOURNI_SERVEUR__ATTACHMENT_SERVEUR_RPC, newAttachment_serveur_rpc, newAttachment_serveur_rpc));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Client_serveurPackage.PORT_FOURNI_SERVEUR__ATTACHMENT_SERVEUR_RPC:
				if (attachment_serveur_rpc != null)
					msgs = ((InternalEObject)attachment_serveur_rpc).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_SERVEUR_RPC__PORT_FOURNI_SERVEUR, Attachment_Serveur_RPC.class, msgs);
