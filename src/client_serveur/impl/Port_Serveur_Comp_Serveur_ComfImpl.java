...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Port Serveur Comp Serveur Comf</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link client_serveur.impl.Port_Serveur_Comp_Serveur_ComfImpl#getBinding_serveur_comp_serveur_conf <em>Binding serveur comp serveur conf</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Port_Serveur_Comp_Serveur_ComfImpl extends PortImpl implements Port_Serveur_Comp_Serveur_Comf {
	/**
	 ...
	 * @generated
	 */
	protected Port_Serveur_Comp_Serveur_ComfImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Client_serveurPackage.Literals.PORT_SERVEUR_COMP_SERVEUR_COMF;
	}
		...
		if (binding_serveur_comp_serveur_conf != null && binding_serveur_comp_serveur_conf.eIsProxy()) {
			...
			if (binding_serveur_comp_serveur_conf != oldBinding_serveur_comp_serveur_conf) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Client_serveurPackage.PORT_SERVEUR_COMP_SERVEUR_COMF__BINDING_SERVEUR_COMP_SERVEUR_CONF, oldBinding_serveur_comp_serveur_conf, binding_serveur_comp_serveur_conf));
			}
		}
	...
	public NotificationChain basicSetBinding_serveur_comp_serveur_conf(Binding_Serveur_Comp_Serveur_Conf newBinding_serveur_comp_serveur_conf, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_SERVEUR_COMP_SERVEUR_COMF__BINDING_SERVEUR_COMP_SERVEUR_CONF, oldBinding_serveur_comp_serveur_conf, newBinding_serveur_comp_serveur_conf);
	...
	public void setBinding_serveur_comp_serveur_conf(Binding_Serveur_Comp_Serveur_Conf newBinding_serveur_comp_serveur_conf) {
		if (newBinding_serveur_comp_serveur_conf != binding_serveur_comp_serveur_conf) {
			...
			if (binding_serveur_comp_serveur_conf != null)
				msgs = ((InternalEObject)binding_serveur_comp_serveur_conf).eInverseRemove(this, Client_serveurPackage.BINDING_SERVEUR_COMP_SERVEUR_CONF__PORT_SERVEUR_COMP_SERVEUR_COMF, Binding_Serveur_Comp_Serveur_Conf.class, msgs);
			if (newBinding_serveur_comp_serveur_conf != null)
				msgs = ((InternalEObject)newBinding_serveur_comp_serveur_conf).eInverseAdd(this, Client_serveurPackage.BINDING_SERVEUR_COMP_SERVEUR_CONF__PORT_SERVEUR_COMP_SERVEUR_COMF, Binding_Serveur_Comp_Serveur_Conf.class, msgs);
			msgs = basicSetBinding_serveur_comp_serveur_conf(newBinding_serveur_comp_serveur_conf, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_SERVEUR_COMP_SERVEUR_COMF__BINDING_SERVEUR_COMP_SERVEUR_CONF, newBinding_serveur_comp_serveur_conf, newBinding_serveur_comp_serveur_conf));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Client_serveurPackage.PORT_SERVEUR_COMP_SERVEUR_COMF__BINDING_SERVEUR_COMP_SERVEUR_CONF:
				if (binding_serveur_comp_serveur_conf != null)
					msgs = ((InternalEObject)binding_serveur_comp_serveur_conf).eInverseRemove(this, Client_serveurPackage.BINDING_SERVEUR_COMP_SERVEUR_CONF__PORT_SERVEUR_COMP_SERVEUR_COMF, Binding_Serveur_Comp_Serveur_Conf.class, msgs);
