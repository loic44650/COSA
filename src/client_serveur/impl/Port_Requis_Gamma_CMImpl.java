...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Port Requis Gamma CM</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link client_serveur.impl.Port_Requis_Gamma_CMImpl#getAttachment_gamma_cm <em>Attachment gamma cm</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Port_Requis_Gamma_CMImpl extends Port_RequisImpl implements Port_Requis_Gamma_CM {
	/**
	 ...
	 * @generated
	 */
	protected Port_Requis_Gamma_CMImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Client_serveurPackage.Literals.PORT_REQUIS_GAMMA_CM;
	}
		...
		if (attachment_gamma_cm != null && attachment_gamma_cm.eIsProxy()) {
			...
			if (attachment_gamma_cm != oldAttachment_gamma_cm) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Client_serveurPackage.PORT_REQUIS_GAMMA_CM__ATTACHMENT_GAMMA_CM, oldAttachment_gamma_cm, attachment_gamma_cm));
			}
		}
	...
	public NotificationChain basicSetAttachment_gamma_cm(Attachment_Gamma_CM newAttachment_gamma_cm, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_REQUIS_GAMMA_CM__ATTACHMENT_GAMMA_CM, oldAttachment_gamma_cm, newAttachment_gamma_cm);
	...
	public void setAttachment_gamma_cm(Attachment_Gamma_CM newAttachment_gamma_cm) {
		if (newAttachment_gamma_cm != attachment_gamma_cm) {
			...
			if (attachment_gamma_cm != null)
				msgs = ((InternalEObject)attachment_gamma_cm).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_GAMMA_CM__PORT_REQUIS_GAMMA_CM, Attachment_Gamma_CM.class, msgs);
			if (newAttachment_gamma_cm != null)
				msgs = ((InternalEObject)newAttachment_gamma_cm).eInverseAdd(this, Client_serveurPackage.ATTACHMENT_GAMMA_CM__PORT_REQUIS_GAMMA_CM, Attachment_Gamma_CM.class, msgs);
			msgs = basicSetAttachment_gamma_cm(newAttachment_gamma_cm, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Client_serveurPackage.PORT_REQUIS_GAMMA_CM__ATTACHMENT_GAMMA_CM, newAttachment_gamma_cm, newAttachment_gamma_cm));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Client_serveurPackage.PORT_REQUIS_GAMMA_CM__ATTACHMENT_GAMMA_CM:
				if (attachment_gamma_cm != null)
					msgs = ((InternalEObject)attachment_gamma_cm).eInverseRemove(this, Client_serveurPackage.ATTACHMENT_GAMMA_CM__PORT_REQUIS_GAMMA_CM, Attachment_Gamma_CM.class, msgs);
